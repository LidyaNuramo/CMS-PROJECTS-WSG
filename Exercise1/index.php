...
?>
		...
		<div class="row">
            <div class="col-sm-12" style="margin-left:1%; margin-top: 70px;">
				...
				<thead>
					<tr class="thead-dark" style="font-size: 16pt;max-width:50%;white-space:nowrap;">
                ...
                <tbody style="font-size: 12pt;color: black;font-weight: bold;background: rgba(192,192,192, 0.7);max-width:50%">
                    <?php
                    $where['id']="";
