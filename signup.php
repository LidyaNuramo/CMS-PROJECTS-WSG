		...
		<ul class="nav justify-content-end">
		  <li class="nav-item">
			<form class="form-inline my-2 my-lg-0" action="index.php">
				<label style="font-size: 11pt;color: black;margin-top:15px;color: white;margin-right: 5%;"> Already have an account?<button class="btn btn-outline-primary" type="submit" style="margin-top:2px;margin-left: 30px;">Sign in</button></label>
			</form>
		  </li>
		</ul>
